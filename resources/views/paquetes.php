			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h2>Revisa todos nuestros paquetes y selecciona el ideal para ti</h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
						...
						.<div class='row row-pb-lg'>
							<div class='col-md-6'>
								<div class='about animate-box'>
									...
									<p><a href='/ver-paquete/".$paquete->idPaquete."'>Ver información de este paquete<i class='icon-arrow-right3'></i></a></p>
								</div>
							</div>
							<div class='col-md-6'>
