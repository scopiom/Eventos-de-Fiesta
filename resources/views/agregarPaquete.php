			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						<form action="/guardarPaquete" method="post" enctype="multipart/form-data">
							<div class="row form-group">
								...
								<div class="col-md-6">
									...
									<input name="descripcion" type="text" id="descripcion" class="form-control" placeholder="Describe sobre lo que trata el paquete">
								</div>
							</div>
							<div class="row form-group">
								<div class="col-md-12">
