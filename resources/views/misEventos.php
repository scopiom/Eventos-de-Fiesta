...
$datosEventos = EventosController::datosMisEventos($idUsuario);
?>
							...
							<ul>
								...
								<?php 
									if (Session::has('nombre'))
									{
										...
										{
											echo "<li class='active'><a href='/misEventos/".session('id')."'>Mis eventos</a></li>";
										}
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Mis eventos</h1>
				   					<h2>Revisa los eventos que tienes pendientes o que ya pasaron</h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
