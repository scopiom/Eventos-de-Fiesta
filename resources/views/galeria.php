<?php 
	...
	$fotosTodas = GaleriaController::todasFotos();
?>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Galería</h1>
				   					<h2>Ve por ti mismo los hermosos espacios que tenemos para ti</h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
		...
		<?php
			...
			foreach ($fotosTodas as $fotos)
			{
				echo "<div class='col-md-6'>
					<img class='img-responsive' src='../images/paquete".$fotos->idPaquete."/".$fotos->url."'>
				</div>";
			}
