	...
	<div id="page">
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>¡¡Suscribase!!</h1>
				   					<h2>Cuando haya nuevos paquetes o modificaciones en paquetes se le será notificado.</h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
		...
		<div class="container my-5">
			<form id="formulario">
				...
				<input type="text" name="correo" placeholder="ingresa correo" class="form-control my-3">
