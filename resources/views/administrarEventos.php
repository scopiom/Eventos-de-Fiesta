...
$datosEventos = EventosController::datosEventos();
?>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Administrador <?php echo session('nombre'); ?></h1>
				   					<h2>eventos</h2>
				   				</div>
				   			</div>
				   		</div>
		...
		<?php 
			...
			foreach ($datosEventos as $eventos) 
			{
							...
							.<div class='row row-pb-lg'>
								<div class='col-md-6'>
									<div class='about animate-box'>
										<h4>Cliente: ".$eventos->nombreUsu." ".$eventos->apellido."</h4>
										<h4>Título: ".$eventos->descripcion."</h4>
										<h4>Fecha evento: ".$eventos->fecha."</h4>
										<h4>Hora: ".$eventos->hora."</h4>
										<h4>Paquete: ".$eventos->nombre."</h4>
										<h4>Nivel: ".$eventos->nivel."</h4>
										<h4>Estado: ".$eventos->estado."</h4>";

				if($eventos->estado == "Pendiente")
				{
					echo "<div class='form-group'>
							<a href='/modificar-evento/".$eventos->idEvento."/2'><button class='btn btn-primary'>Confirmar</button></a>
							<a href='/modificar-evento/".$eventos->idEvento."/3'><button class='btn btn-primary'>Cancelar</button></a>
							<a><button class='btn btn-primary'>Devolver</button></a>
						</div>";
				}
